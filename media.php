                ...
                <div class="row align-content-center align-items-center" style="min-height: 300px !important;">
                    <div class="col-xl-7">
                        <div class="breadcrumb" data-aos="fade-in">
                            <a href="#">Media</a><a href="#">PDF</a>
                        </div>
                        <div class="title">
                            <h1 data-aos="fade-right">Media</h1>
                            <p data-aos="fade-right">Download PDF Documents</p>
                            <div class="datasheets d-md-flex col-xl-4" data-aos="fade-up">

                                <a href="assets/pdf/NC_brochure.pdf" class="btn-data-w lightbox" aria-haspopup="dialog" title="Download.pdf">Media Kit
