...
$('.trigs-m').slick({
  ...
  asNavFor: '.main-pusher, .img-pusher',
  arrows: false,
  centerMode: false,
  focusOnSelect: true,
});
...
$(function() {
  ...
  $(".prodFilter li").on('click', function(){
    ...
    if(filter == 'pid-1'){
      ...
      if ($(".prodFilter li").hasClass('active-prod')) {
        $(".prodFilter li").removeClass('active-prod');
      } else {
  
      }

      if ($(".prodFilter .pid-1").hasClass('active-prod')) {
        $(".prodFilter .pid-1").removeClass('active-prod');
      } else {
        $(".prodFilter .pid-1").addClass('active-prod');
      }
    }
      ...
      if ($(".prodFilter .pid-2").hasClass('active-prod')) {
        $(".prodFilter .pid-2").removeClass('active-prod');
      } else {
        $(".prodFilter .pid-2").addClass('active-prod');
      }
    }
      ...
      if ($(".prodFilter .pid-3").hasClass('active-prod')) {
        $(".prodFilter .pid-3").removeClass('active-prod');
      } else {
        $(".prodFilter .pid-3").addClass('active-prod');
      }
    }
      ...
      if ($(".prodFilter .pid-4").hasClass('active-prod')) {
        $(".prodFilter .pid-4").removeClass('active-prod');
      } else {
        $(".prodFilter .pid-4").addClass('active-prod');
      }
    }
      ...
      if ($(".prodFilter .pid-5").hasClass('active-prod')) {
        $(".prodFilter .pid-5").removeClass('active-prod');
      } else {
        $(".prodFilter .pid-5").addClass('active-prod');
      }
    }
      ...
      if ($(".prodFilter .pid-6").hasClass('active-prod')) {
        $(".prodFilter .pid-6").removeClass('active-prod');
      } else {
        $(".prodFilter .pid-6").addClass('active-prod');
      }
    }
    else if(filter == 'all'){
