                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown has-megamenu">
                            <a class="nav-link dropdown-toggle active" href="prod-list.html">Products</a>
                ...
                <div class="row align-content-center align-items-center">
                    <div class="col-xl-7">
                        ...
                        <div class="title" data-aos="fade-right">
                            <h1>DESKTOP NETWORK APPLIANCES</h1>
                            <p>Cras ac tortor at magna porttitor consequat quis a lacus. Suspendisse maximus purus vestibulum, tempor tortor vel, dignissim tortor. Sed sed commodo orci. Nullam eget lectus aliquam, egestas nisl non, vehicula elit.
                            </p>
                        </div>
                    </div>
